...
export const BRIEFS_DB = {
  ...
  sustainable_growth: {
    ...
    icon: '🌱',
    color: '#60ff80',
    effectShort: 'RECOVERY: +15 chips per 1% WB healed. Cannot reduce TOX.',
  ...
  scale_or_fail: {
    ...
    icon: '🚀',
    color: '#ff9966',
    effectShort: 'Passing gives +0.4/0.5/0.6 perm Eff instead of CC. KPI +10% harder.',
    constraintShort: 'KPI targets +10%. No CC from weekly pass.',
