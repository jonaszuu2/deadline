...
export const TREE_NODES = {
  ...
  p_chips:  { id:'p_chips',  x:1, y:1, cost:1, arch:'PRODUCTION', type:'stat',
    name:'Efficiency Drive',   short:'+150 Output to every PRODUCTION card played',
  ...
  p_chain:  { id:'p_chain',  x:2, y:2, cost:1, arch:'PRODUCTION', type:'synergy',
    name:'Assembly Line',      short:'Pure PRODUCTION turn: Output ×1.25',
    connects:['p_chips','p_engine','h_ps'] },
  p_engine: { id:'p_engine', x:1, y:3, cost:2, arch:'PRODUCTION', type:'synergy',
    name:'Flow State',         short:'Each PRODUCTION card in play: other PRODs +75 Output',
  ...
  s_mult:   { id:'s_mult',   x:5, y:1, cost:1, arch:'STRATEGY',   type:'stat',
    name:'Strategic Vision',   short:'+0.3 permanent Eff (applied immediately)',
    connects:['s_first','s_stack'] },
  s_first:  { id:'s_first',  x:6, y:2, cost:1, arch:'STRATEGY',   type:'synergy',
    name:'First Mover',        short:'First STRATEGY each turn: its Eff contribution doubled',
    connects:['s_mult'] },
  s_stack:  { id:'s_stack',  x:4, y:2, cost:2, arch:'STRATEGY',   type:'synergy',
    name:'Momentum Build',     short:'Each STRATEGY played this week: +0.1 Eff all future turns',
    connects:['s_mult','s_flow','h_ps'] },
  s_flow:   { id:'s_flow',   x:5, y:3, cost:2, arch:'STRATEGY',   type:'synergy',
    name:'Pure Execution',     short:'STRATEGY with no PRODUCTION in play: +0.6 extra Eff',
    connects:['s_stack','s_cap','h_sc'] },
  s_cap:    { id:'s_cap',    x:6, y:4, cost:3, arch:'STRATEGY',   type:'capstone',
    name:'LEVERAGE',           short:'Permanent Eff counted TWICE in final score calculation',
    connects:['s_flow'] },
  ...
  r_glow:   { id:'r_glow',   x:2, y:6, cost:2, arch:'RECOVERY',   type:'synergy',
    name:'Peak Performance',   short:'WB ≥ 80% at turn start: +0.2 Eff this turn',
  ...
  c_chips:  { id:'c_chips',  x:5, y:5, cost:1, arch:'CRUNCH',     type:'stat',
    name:'Crunch Bonus',       short:'CRUNCH cards generate +50% Output',
  ...
  c_rage:   { id:'c_rage',   x:5, y:7, cost:2, arch:'CRUNCH',     type:'synergy',
    name:'Toxic Fuel',         short:'TOX > 50%: CRUNCH Eff contribution doubled',
    connects:['c_resist','c_clean','c_cap'] },
  c_cap:    { id:'c_cap',    x:6, y:8, cost:3, arch:'CRUNCH',     type:'capstone',
    name:'PRESSURE COOKER',    short:'Every 10% TOX above 30% adds +0.15 Eff to all plays',
    connects:['c_rage'] },

  // ── Hybrid / Center ─────────────────────────────────
  center:   { id:'center',   x:3, y:4, cost:2, arch:'HYBRID',     type:'synergy',
    name:'Cross-Functional',   short:'Play all 4 archetypes in one week: +0.3 permanent Eff',
    connects:['h_ps','h_pr','h_sc','h_rc'] },
  h_ps:     { id:'h_ps',     x:3, y:2, cost:2, arch:'HYBRID',     type:'synergy',
    name:'Synergy Sprint',     short:'Turn with PRODUCTION + STRATEGY together: +2.0 Eff',
  ...
  h_sc:     { id:'h_sc',     x:4, y:4, cost:2, arch:'HYBRID',     type:'synergy',
    name:'Chaos Strategy',     short:'STRATEGY when TOX > 40%: +0.8 Eff per STRATEGY card',
    connects:['s_flow','center','c_clean'] },
  h_rc:     { id:'h_rc',     x:3, y:6, cost:2, arch:'HYBRID',     type:'synergy',
    name:'Desperate Sprint',   short:'WB < 50%: each CRUNCH card gets +500 Output',
