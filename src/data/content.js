...
export const TEAMMATES_DB = {
  gary:{
    ...
    tiers:[
      {tier:1,name:'Unusually Helpful',
       buffText:'+5 Output per card played — no removal.',
       penaltyText:'None.',
  ...
  alex:{
    ...
    buffText:'+20 Output for every card played in a single turn (stacks per card in combo).',
  ...
  marcus:{
    ...
    buffText:'+20 Output per PRODUCTION card played. He personally approves each deliverable.',
    penaltyText:'STRATEGY cards cost +8 Toxicity — "Why are we wasting time planning?"',
    tiers:[
      {tier:1,name:'Performance Coach',
       buffText:'+20 Output per PRODUCTION card. +5 WB per PRODUCTION played.',
      ...
      {tier:2,name:'The Micromanager',
       buffText:'+20 Output per PRODUCTION card.',
      ...
      {tier:3,name:'Total Control',
       buffText:'+40 Output per PRODUCTION card.',
