...
export const STATUS_EFFECTS_DB = {
  ...
  bo:[
    ...
    {min:50,max:79,label:'Stressed',color:'#ffdd44',
     desc:'Efficiency from cards reduced by 20%. You keep re-reading the same email.'},
